class ExternalLinkInfo {
  ...
  static List<ExternalLinkInfo> getAllExternalLinks({String? searchQuery}) {
    return [
      ...
      ExternalLinkInfo(
        title: "DUT subjects register",
        description: "The DUT subjects register..",
        type: "official",
        url: [
          'https://dk1.dut.udn.vn',
          'https://dk2.dut.udn.vn',
          'https://dk3.dut.udn.vn',
          'https://dk4.dut.udn.vn',
        ],
      ),
      ExternalLinkInfo(
        title: "Forum link",
      ...
      ExternalLinkInfo(
        ...
        type: "social",
        url: [
          'https://www.facebook.com/ctsvdhbkdhdn/posts/'
              'pfbid02dHKp7h9gd2qPsfK3n4veQ7gfD9mJ3af2Mgz8V2vt5z6WAXPXstRwzu9Vd8iHjEgfl',
        ],
      ),
    ].where((p) {
      return p.title.toLowerCase().contains(searchQuery?.toLowerCase() ?? "") ||
          p.url.any((p) => p.toLowerCase().contains(searchQuery?.toLowerCase() ?? "")) ||
